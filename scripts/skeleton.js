// This script is used to load the skeleton of the page, including the navbar and the bottom navbar.

// Global Firebase auth reference
const auth = firebase.auth();

// Function to insert the first name of the user from Firestore
...
// This function loads the HTML content based on the user's login status
