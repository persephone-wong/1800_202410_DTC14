// Description: This file contains the functions to display the event cards on
// the list view page and the function to update the favorite list.
var currentUser;
